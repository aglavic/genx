...
class MainFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.mb_new = wx.MenuItem(self.mb_file, wx.NewId(), "New...", "", wx.ITEM_NORMAL)
        self.mb_file.AppendItem(self.mb_new)
        self.mb_open = wx.MenuItem(self.mb_file, wx.NewId(), "Open...", "", wx.ITEM_NORMAL)
        self.mb_file.AppendItem(self.mb_open)
        self.mb_save = wx.MenuItem(self.mb_file, wx.NewId(), "Save...", "", wx.ITEM_NORMAL)
        self.mb_file.AppendItem(self.mb_save)
        self.mb_saveas = wx.MenuItem(self.mb_file, wx.NewId(), "Save As...", "", wx.ITEM_NORMAL)
        self.mb_file.AppendItem(self.mb_saveas)
        self.mb_file.AppendSeparator()
        mb_import = wx.Menu()
        self.mb_import_data = wx.MenuItem(mb_import, wx.NewId(), "Import Data...", "", wx.ITEM_NORMAL)
        mb_import.AppendItem(self.mb_import_data)
        self.mb_import_table = wx.MenuItem(mb_import, wx.NewId(), "Import Table...", "", wx.ITEM_NORMAL)
        mb_import.AppendItem(self.mb_import_table)
        self.mb_import_script = wx.MenuItem(mb_import, wx.NewId(), "Import Script...", "", wx.ITEM_NORMAL)
        mb_import.AppendItem(self.mb_import_script)
        self.mb_file.AppendMenu(wx.NewId(), "Import", mb_import, "")
        mb_export = wx.Menu()
        self.mb_export_data = wx.MenuItem(mb_export, wx.NewId(), "Export Data...", "", wx.ITEM_NORMAL)
        mb_export.AppendItem(self.mb_export_data)
        self.mb_export_table = wx.MenuItem(mb_export, wx.NewId(), "Export Table...", "", wx.ITEM_NORMAL)
        mb_export.AppendItem(self.mb_export_table)
        self.mb_export_script = wx.MenuItem(mb_export, wx.NewId(), "Export Script...", "", wx.ITEM_NORMAL)
        mb_export.AppendItem(self.mb_export_script)
        self.mb_file.AppendMenu(wx.NewId(), "Export", mb_export, "")
        self.mb_file.AppendSeparator()
        mb_print = wx.Menu()
        self.mb_print_plot = wx.MenuItem(mb_print, wx.NewId(), "Print Plot...", "", wx.ITEM_NORMAL)
        mb_print.AppendItem(self.mb_print_plot)
        self.mb_print_grid = wx.MenuItem(mb_print, wx.NewId(), "Print Grid...", "", wx.ITEM_NORMAL)
        mb_print.AppendItem(self.mb_print_grid)
        self.mb_print_script = wx.MenuItem(mb_print, wx.NewId(), "Print Script...", "", wx.ITEM_NORMAL)
        mb_print.AppendItem(self.mb_print_script)
        self.mb_file.AppendMenu(wx.NewId(), "Print", mb_print, "")
        self.mb_file.AppendSeparator()
        self.mb_quit = wx.MenuItem(self.mb_file, wx.NewId(), "Quit", "", wx.ITEM_NORMAL)
        ...
        self.mb_view_zoom = wx.MenuItem(self.mb_view, wx.NewId(), "Zoom", "Turn the zoom on/off", wx.ITEM_CHECK)
        self.mb_view.AppendItem(self.mb_view_zoom)
        self.mb_view_zoomall = wx.MenuItem(self.mb_view, wx.NewId(), "Zoom All", "Zoom to fit all data points", wx.ITEM_NORMAL)
        ...
        self.mb_fit = wx.Menu()
        self.mb_fit_start = wx.MenuItem(self.mb_fit, wx.NewId(), "Start", "Start fitting", wx.ITEM_NORMAL)
        self.mb_fit.AppendItem(self.mb_fit_start)
        self.mb_fit_stop = wx.MenuItem(self.mb_fit, wx.NewId(), "Stop", "Stop fitting", wx.ITEM_NORMAL)
        self.mb_fit.AppendItem(self.mb_fit_stop)
        self.mb_fit_resume = wx.MenuItem(self.mb_fit, wx.NewId(), "Resume", "Resume fitting", wx.ITEM_NORMAL)
        ...
        self.mb_set_opt = wx.MenuItem(self.mb_set, wx.NewId(), "Optimizer", "", wx.ITEM_NORMAL)
        self.mb_set.AppendItem(self.mb_set_opt)
        self.mb_set_dataloader = wx.MenuItem(self.mb_set, wx.NewId(), "Data Loader", "", wx.ITEM_NORMAL)
        ...
        self.main_frame_toolbar.AddLabelTool(10001, "tb_new", (img.getnewBitmap()), wx.NullBitmap, wx.ITEM_NORMAL, "New model", "Create a new model")
        self.main_frame_toolbar.AddLabelTool(10002, "tb_open", (img.getopenBitmap()), wx.NullBitmap, wx.ITEM_NORMAL, "Open", "Open an existing model")
        self.main_frame_toolbar.AddLabelTool(10003, "tb_save", (img.getsaveBitmap()), wx.NullBitmap, wx.ITEM_NORMAL, "Save", "Save model to file")
        self.main_frame_toolbar.AddLabelTool(10004, "tb_simulate", (img.getsimulateBitmap()), wx.NullBitmap, wx.ITEM_NORMAL, "Simulate", "Simulate the model")
        self.main_frame_toolbar.AddLabelTool(10005, "tb_start_fit", (img.getstart_fitBitmap()), wx.NullBitmap, wx.ITEM_NORMAL, "Start fit", "Start fitting")
        self.main_frame_toolbar.AddLabelTool(10006, "tb_stop_fit", (img.getstop_fitBitmap()), wx.NullBitmap, wx.ITEM_NORMAL, "Stop fit", "Stop fitting")
        self.main_frame_toolbar.AddLabelTool(10007, "tb_restart_fit", (img.getrestart_fitBitmap()), wx.NullBitmap, wx.ITEM_NORMAL, "Restart fit", "Restart the fit")
        ...
        self.main_frame_toolbar.AddLabelTool(10009, "tb_zoom", (img.getzoomBitmap()), wx.NullBitmap, wx.ITEM_CHECK, "Zoom", "Turn zoom on/off")
        # Tool Bar end
