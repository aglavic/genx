...
class SettingsDialog(wx.Dialog):
    ...
    def get_entry(self, field, parent, add_label=True):
        ...
        if field.type is bool:
            ...
            spin.SetMinSize(spin.GetSizeFromText(str(gmeta['pmax'])+"    "))
    ...
    def label_entry(self, parent, entry, label):
        ...
        out_entry.Add(wx.StaticText(parent, -1, label, style=wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL),
                      0, wx.FIXED_MINSIZE|wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 8)
