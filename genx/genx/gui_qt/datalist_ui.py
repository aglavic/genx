...
class Ui_DataListControl(object):
    def setupUi(self, DataListControl):
        ...
        icon = QIcon()
        icon.addFile(u":/main_gui/add.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon.addFile(u":/main_gui/add.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/main_gui/open.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon1.addFile(u":/main_gui/open.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/main_gui/add_simulation.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon2.addFile(u":/main_gui/add_simulation.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/main_gui/move_up.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon4.addFile(u":/main_gui/move_up.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/main_gui/move_down.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon5.addFile(u":/main_gui/move_down.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.actionMoveDown.setIcon(icon5)
        self.actionDelete = QAction(DataListControl)
        self.actionDelete.setObjectName(u"actionDelete")
        icon6 = QIcon()
        icon6.addFile(u":/main_gui/delete.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon6.addFile(u":/main_gui/delete.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/main_gui/plotting.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon7.addFile(u":/main_gui/plotting.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.actionPlotting.setIcon(icon7)
        self.actionCalc = QAction(DataListControl)
        self.actionCalc.setObjectName(u"actionCalc")
        icon8 = QIcon()
        icon8.addFile(u":/main_gui/calc.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon8.addFile(u":/main_gui/calc.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
