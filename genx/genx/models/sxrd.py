...
class Sample:
    ...
    def __init__(self, inst, bulk_slab, slabs, unit_cell, surface_sym=None, bulk_sym=None):
...
class UnitCell:
    ...
    def dist(self, x1, y1, z1, x2, y2, z2):
        ...
        return np.sqrt(((x1 - x2) * self.a) ** 2 + ((y1 - y2) * self.b) ** 2 + ((z1 - z2) * self.c) ** 2)
...
if __name__ == "__main__":
    ...
    sample = Sample(inst, bulk, [ss1] * 1, UnitCell(3.945, 3.945, 3.945, 90, 90, 90))
    ...
    sample2 = Sample(inst, bulk, [s_sym] * 1, UnitCell(3.945, 3.945, 3.945, 90, 90, 90))
