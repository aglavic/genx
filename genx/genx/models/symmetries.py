...
pg = Sym(SymTrans([[1, 0], [0, 1]]), SymTrans([[-1, 0], [0, 1]], [0, 1.0 / 2]))
cm = Sym(
    SymTrans([[1, 0], [0, 1]]),
    SymTrans([[-1, 0], [0, 1]]),
    SymTrans([[1, 0], [0, 1]], [1.0 / 2, 1.0 / 2]),
    SymTrans([[-1, 0], [0, 1]], [1.0 / 2, 1.0 / 2]),
)
p2mm = Sym(
    SymTrans([[1, 0], [0, 1]]), SymTrans([[-1, 0], [0, -1]]), SymTrans([[-1, 0], [0, 1]]), SymTrans([[1, 0], [0, -1]])
)
p2mg = Sym(
    SymTrans([[1, 0], [0, 1]]),
    SymTrans([[-1, 0], [0, -1]]),
    SymTrans([[-1, 0], [0, 1]], [1.0 / 2, 0]),
    SymTrans([[1, 0], [0, -1]], [1.0 / 2, 0]),
)
p2gg = Sym(
    SymTrans([[1, 0], [0, 1]]),
...
p4 = Sym(
    SymTrans([[1, 0], [0, 1]]), SymTrans([[-1, 0], [0, -1]]), SymTrans([[0, -1], [1, 0]]), SymTrans([[0, 1], [-1, 0]])
)
p4mm = Sym(
    SymTrans([[1, 0], [0, 1]]),
    SymTrans([[-1, 0], [0, -1]]),
